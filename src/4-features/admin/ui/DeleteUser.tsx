...
export const DeleteUserModal = ({ isOpen, onClose, user, onConfirm, isLoading = false }: DeleteUserModalProps) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="sm" closeOnOverlayClick={!isLoading}>
      ...
      <ModalContent>
        <div style={{ textAlign: 'center', padding: '1rem 0' }}>
          ...
          <p style={{ margin: '0 0 0.5rem 0', fontSize: '1rem', fontWeight: '500' }}>Вы уверены, что хотите удалить пользователя?</p>

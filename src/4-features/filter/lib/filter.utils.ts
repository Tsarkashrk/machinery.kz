...
export const convertFormDataToFilters = (formData: IFilterFormData): IEquipmentFilters => {
  ...
  if (formData.available_for_rent) filters.available_for_rent = formData.available_for_rent
  if (formData.available_for_sale) filters.available_for_sale = formData.available_for_sale
  ...
  if (formData.min_rental_rate) filters.min_rental_rate = Number(formData.min_rental_rate)
  if (formData.max_rental_rate) filters.max_rental_rate = Number(formData.max_rental_rate)

...
export const AdminSidebar = () => {
  ...
  const userManagement = [
    {
      name: "Пользователи",
      path: `${DASHBOARD_PAGES.USERS}`,
      icon: <Users size={ICON_SIZE} />,
    },
    {
      name: "Компании",
      path: `${DASHBOARD_PAGES.COMPANIES}`,
  ...
  const platformManagement = [
    {
      name: t("categories"),
      path: `${DASHBOARD_PAGES.CATEGORIES}`,
      icon: <ChartGantt size={ICON_SIZE} />,
    },
    {
      name: t("brands"),
      path: `${DASHBOARD_PAGES.BRANDS}`,
  ...
  const publicationManagement = [
    {
      name: t("publications"),
      path: `${DASHBOARD_PAGES.PUBLICATIONS}`,
      icon: <PanelsLeftBottomIcon size={ICON_SIZE} />,
    },
    {
      name: t("verification"),
      path: `${DASHBOARD_PAGES.VERIFICATION}`,

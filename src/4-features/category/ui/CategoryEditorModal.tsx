...
export const CategoryEditorModal = ({ isOpen, onClose, item, onSave, isLoading = false }: CreateCategoryModalProps) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="modal-form" id="company-form">
          <div className="form-grid form-grid--cols-2">
            <div className="form-group">
              <label className="form-label form-label--required">Название категории</label>

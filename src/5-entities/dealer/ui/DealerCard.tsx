...
export const DealerCard = ({ userDealer, companyDealer }: Props) => {
  ...
  return (
    <Link className="dealer-card" href={`${PLATFORM_PAGES.DEALERS}/${userDealer ? userDealer?.id : companyDealer?.id}`}>
      <div className="dealer-card__wrapper">
        <Image className="dealer-card__image" width={300} height={300} src="/assets/profile-placeholder.png" alt={'profile image'} />

...
import Header from "@/6-shared/ui/Header/Header";
import { SITE_NAME } from "@/6-shared/constants/seo.constant";
import { Providers } from "./providers";
import { Toaster } from "sonner";
import Footer from "@/6-shared/ui/Footer/Footer";
...
export default async function RootLayout({
  ...
  return (
    <html lang={locale}>
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${inter.variable} ${gilroyFont.className}`}
      >
        <Providers>

...
export const ChatHeader = ({ chat, link, avatar, username, isOnline, isReconnecting, timestamp }: Props) => {
    ...
    <div className="chat-header">
      <div className="chat-header__wrapper">
        <div className="chat-header__info">
          <Avatar size="big" username={interlocutorChat.username} link={`${PLATFORM_PAGES.DEALERS}/${link}`} />
          <div className="chat-header__status">
            <h3 className="chat-header__username">{interlocutorChat.username}</h3>
            <div className="chat-header__status">
              {
                isReconnecting && <span className="text-yellow-500 text-sm">переподключение...</span>
